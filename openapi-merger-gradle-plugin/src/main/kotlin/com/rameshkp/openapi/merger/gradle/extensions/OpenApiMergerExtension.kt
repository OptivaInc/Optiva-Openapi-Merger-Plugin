...
/**
 *  An extension for OpenAPI merger object
 */
open class OpenApiMergerExtension @Inject constructor(objectFactory: ObjectFactory) {
    ...
    internal val openApi: OpenApiExtension = objectFactory.newInstance(OpenApiExtension::class.java)
    internal val output: OutputExtension = objectFactory.newInstance(OutputExtension::class.java)
